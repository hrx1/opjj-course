...
/**
 * Class describes Complex numbers and provids simple operations with them.
 * 
 * @author Hrvoje
 *
 */
public class Complex {
	/** Defines complex number **/
	private double real, imaginary;
	private double magnitude, angle;
	/** Tolerance taken when comparing numbers **/
	...
	/*
	 * Constructor for complex number with real and imaginary part
	 */
...
//		return fromMagnitudeAndAngle(abs(this.magnitude * c.magnitude), this.angle + c.angle);
	...
	public Complex power(int n) {
		...
		return fromMagnitudeAndAngle(pow(this.magnitude, n), n * this.angle);
	}
	...
	public List<Complex> root(int n) {
		...
		double magnitudeResult = pow(this.magnitude, 1. / n);
	...
	/**
	 * Checks whether two complex numbers are similar.
	 * 
	 * @param c1 first
	 * @param c2 second
	 * @param threshold taken when comparing
	 * 
	 * @return true if complex numbers are similar
	 */
	...
	/**
	 * Checks whether difference of modules of c1 and c2 is within threshold.
	 * @param c1 first complex 
	 * @param c2 second complex
	 * @param threshold threshold
	 * @return true if difference of modules of c1 and c2 is within threshold
	 */
